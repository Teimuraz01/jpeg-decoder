...
extern const char *jpeg_get_filename(const struct jpeg_desc *jpeg);

// DHT header section parsing
extern void jpeg_read_dht(struct jpeg_desc *jpeg, struct bitstream *stream);

// SOS header section parsing
extern void jpeg_read_sos(struct jpeg_desc *jpeg, struct bitstream *stream);
